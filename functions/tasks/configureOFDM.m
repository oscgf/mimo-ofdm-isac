...
function ofdm = configureOFDM(systemParams, antennas, scenario)
    ...
    ofdm.subframeALength = ofdm.frameLength - antennas.Ntx;                 % Subframe A length
    ofdm.subframeBLength = antennas.Ntx;                               % Subframe B length
